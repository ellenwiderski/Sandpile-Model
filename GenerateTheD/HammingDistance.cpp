...
uint64_t LCS::Pairs(MATCHES& matches, shared_ptr<Pair> *pairs) {
  ...
  //
void LCS::Match(CHAR2INDEXES& indexes, MATCHES& matches,
...
string LCS::Select(shared_ptr<Pair> pairs, uint64_t length,
...
string LCS::Correspondence(const string& s1, const string& s2) {
